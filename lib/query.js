...
// db.query(
//   `INSERT INTO employee(first_name, last_name, manager) VALUES (?,?,)`, [answers.firstName, answers.lastName, answers.manager], `INSERT INTO role(title, salary) VALUES(?,?)`, [answers.role, answers.salary],
//   function (err, res) {
//     if (err) {
//       console.log(err);
//     }
